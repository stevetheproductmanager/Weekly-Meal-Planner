...
function ConfirmDialog({
  ...
  const confirmClasses =
    confirmVariant === 'secondary'
      ? 'inline-flex items-center rounded-md border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium text-slate-900 hover:border-emerald-500 hover:text-emerald-700 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100'
      : 'inline-flex items-center rounded-md bg-red-500 px-4 py-2.5 text-sm font-medium text-white shadow-sm hover:bg-red-400';
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="px-4 py-4 space-y-2 text-sm text-slate-800 dark:text-slate-200">
          <p>{message}</p>
          {warning && (
        ...
        <div
          className="flex justify-end gap-2 px-4 py-3 border-t border-slate-200 dark:border-slate-800"
